...
3. On the **Srv-Work-XX** blade, click **Networking**.
...
4. Download the RDP file and use it to connect to the **Srv-Jump-XX** Azure VM via Remote Desktop. When prompted to authenticate, provide the following credntials:
