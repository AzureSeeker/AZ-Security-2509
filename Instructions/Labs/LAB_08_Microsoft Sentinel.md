...
4. On the **Just-in-time VM access** blade, on the right hand side of the row referencing the **myVMXX** virtual machine, click the **ellipsis (...)** button, click **Remove** and then click **Yes**.
